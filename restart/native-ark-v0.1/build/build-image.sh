...
validate_guest_contract no_baked_agent_private_keys 'for role in kyle aletheia joey hrm kenny; do ! test -e "/ark/agents/$role/private/signing-key.pem" || exit 1; done'
